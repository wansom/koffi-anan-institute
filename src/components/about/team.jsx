        ...
        <div className="flex items-center justify-center" >
          <div className="flex items-center"  onClick={handlePrevPage}>
            ...
            >
              ...
              />
            </svg> <p  className={`${!hasPreviousPage && 'hidden'} -mt-3 text-[#25518c] `}>Previous</p>
          </div>
          <div className="flex items-center justify-center" onClick={handleNextPage}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <p  className={`${!hasNextPage && 'hidden'} -mt-3 text-[#25518c]`}>View More</p>
          </div>
        </div>
      </div>
    </section>
