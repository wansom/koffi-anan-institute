const Test=()=>{
    return(
        ...
        <div class="header-container container">
            <div class="logo">
                <img src="images/home/logo.png" alt="Kofi Annan  Annan Institute for Conflict Transformation Logo"/>
            </div>
    ...
    <nav>
        <div class="nav-container container">
            <div class="nav logo">
                <a href="index.html" class="nav-logo"><img src="images/home/logo.png"
                        alt="Kofi Annan  Annan Institute for Conflict Transformation Logo" width="80px"/> K.A.I.C.T</a>
            </div>
            <div class="links" id="links">
                ...
                <a href="#">Think Tanks <i class="fa-solid fa-angle-down"></i></a>
